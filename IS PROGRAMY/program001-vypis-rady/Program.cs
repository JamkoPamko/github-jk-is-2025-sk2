...
while (again == "a")
{
    ...
    Console.Write("Zadejte diferenci (celé číslo): "); //rozdíl mezi čísly v řadě
    int step;
    ...
    Console.WriteLine("Diference: {0}", step); //rozdíl mezi čísly v řadě
    Console.WriteLine("============================================");
    ...
    int current = first; // počáteční hodnota pro výpis řady
    while(current <= last) {
